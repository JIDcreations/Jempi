      ...
      '<nav class="nav" data-nav>' +
        '<div class="nav__bar">' +
          '<a class="nav__logo" href="index.html">' +
            '<img class="logo-light" src="assets/logo-licht.svg" alt="Jempi Travel" style="filter:brightness(0) invert(1);">' +
            '<img class="logo-dark" src="assets/logo-choc.svg" alt="Jempi Travel">' +
          '</a>' +
      ...
      '<div class="container">' +
        ...
        '<div class="footer__cols">' +
          '<div class="footer__brand">' +
            '<img src="assets/logo-licht.svg" alt="Jempi Travel" style="filter:brightness(0) invert(1);">' +
